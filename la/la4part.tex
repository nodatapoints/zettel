...
\begin{gather*}
	 a_0v_0 + a_1(v_1-v_0) + \dots + a_r(v_r - v_0) = \underbrace{(a_0 - a_1 - \dots - a_r)}_{a_0'} v_0 + a_1v_1 + \dots + a_rv_r
\end{gather*}
2. Richtung \quad $\mathrm{Lin}(\{v_0,\ \dots,\ v_n\}) \subseteq \mathrm{Lin}(\{v_0,\ v_1 - v_0,\ \dots,\ v_r - v_0\})$
\begin{gather*}
	 a_0v_0 + \dots + a_rv_r = \underbrace{(a_0 + \dots + a_r)}_{a_0'}v_0 + a_1(v_1-v_0) + \dots + a_r(v_r - v_0)
\end{gather*}
\end{proof}
\ttask
