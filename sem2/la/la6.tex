...
\end{gather*}
Demnach ist $v_3 \in \Lin(w_1,\,w_2) = \Lin(v_1,\,v_2,\,v_3) = W$. Die ONB lautet
...
\tttask
Die vollständige Darstellungsmatrix von $\gamma$ auf $V$ in der Basis $E_4 = (e_0,\,\dots,\,e_3) = (1,\,t,\,t^2,\,t^3)$ ergibt sich als
...
\begin{gather*}
    ...
    W^\perp = \Lin(p_W(t^3) - t^3) = \Lin\qty(-9 + 13t + 15t^2 - t^3) \qq{da} W \oplus W^\perp = V \qq{und} \dim W = 3
\end{gather*}
\end{document}
